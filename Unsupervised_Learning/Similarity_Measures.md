...
| **Manhattan Distance (L1)** | ( d(x, y) = \sum                                  | x_i - y_i                                     | )           | For grid-like data or sparse features.             |     |                                     |   |   |     |                                                  |
...
| **Jaccard Similarity**      | ( S(A, B) = \frac{                                | A ∩ B                                         | }{          | A ∪ B                                              | } ) | For binary/categorical or set data. |   |   |     |                                                  |
| **Correlation Coefficient** | Measures linear relationship between two vectors. | Used in pattern and document clustering.      |             |                                                    |     |                                     |   |   |     |                                                  |
